...
/**
 * The actual implementation of the command pattern for the strobe light toggle button in default Xplane.
 ...
 * @since 0.4.0
 */
public class LightsStrobeToggleSend implements OutCommand {

    private static final Logger log = LoggerFactory.getLogger(LightsStrobeToggleSend.class);
    ...
    public void execute() {
        ...
        log.trace("execute(): Strobe lights toggled");
    }
}
