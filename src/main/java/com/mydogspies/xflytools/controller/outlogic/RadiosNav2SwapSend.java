...
/**
 * The actual implementation of the command pattern for the Nav 2 radio swap button in Xflytools.
 ...
 * @since 0.4.0
 */
public class RadiosNav2SwapSend implements OutCommand {

    private static final Logger log = LoggerFactory.getLogger(RadiosNav2SwapSend.class);
