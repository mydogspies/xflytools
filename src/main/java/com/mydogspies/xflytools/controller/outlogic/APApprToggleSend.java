...
/**
 * The actual implementation of the command pattern for the autopilot APPR toggle button in default Xplane.
 ...
 * @since 0.4.0
 */
public class APApprToggleSend implements OutCommand {

    private static final Logger log = LoggerFactory.getLogger(APApprToggleSend.class);
    ...
    public void execute() {
        ...
        log.trace("execute(): A/P set to APR mode.");
    }
}
