...
/**
 * The actual implementation of the command pattern for the Com 1 radio swap button in Xflytools.
 ...
 * @since 0.4.0
 */
public class RadiosCom1SwapSend implements OutCommand {

    private static final Logger log = LoggerFactory.getLogger(RadiosCom1SwapSend.class);
