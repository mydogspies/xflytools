...
public class DefaultRadios {
    ...
    /**
     * Updates all dynamic data in the UI.
        ...
        switch (command) {
            ...
            case "com1_freq":
                ...
                if (!com1Text.getText().equals(formatted)) {
                    ...
                    log.trace("updateData(): [" + command + "] -> com1 active set to " + formatted);
                }
                break;
            ...
            case "com2_freq":
                ...
                if (!com2Text.getText().equals(formatted2)) {
                    ...
                    log.trace("updateData(): [" + command + "] -> com2 active set to " + formatted2);
                }
                break;
            ...
            case "nav1_freq":
                ...
                if (!nav1Text.getText().equals(formatted3)) {
                    ...
                    log.trace("updateData(): [" + command + "] -> nav1 active set to " + formatted3);
                }
                break;
            ...
            case "nav2_freq":
                ...
                if (!nav2Text.getText().equals(formatted4)) {
                    ...
                    log.trace("updateData(): [" + command + "] -> nav2 active set to " + value);
                }
                break;
            ...
            case "transponder_code":
                if (!transponder.getText().equals(value.get(0))) {
                    ...
                    log.trace("updateData(): [" + command + "] -> transponder set to " + value);
                }
                break;
            ...
            case "com1_stdby_freq":
                ...
                if (!com1Stby.getText().equals(formatted5)) {
                    ...
                    log.trace("updateData(): [" + command + "] -> com1 stand-by set to " + formatted5);
                }
                break;
            ...
            case "com2_stdby_freq":
                ...
                if (!com2Stby.getText().equals(formatted6)) {
                    ...
                    log.trace("updateData(): [" + command + "] -> com2 stand-by set to " + formatted6);
                }
                break;
            ...
            case "nav1_stdby_freq":
                ...
                if (!nav1Stby.getText().equals(formatted7)) {
                    ...
                    log.trace("updateData(): [" + command + "] -> nav1 stand-by set to " + formatted7);
                }
                break;
            ...
            case "nav2_stdby_freq":
                ...
                if (!nav2Stby.getText().equals(formatted8)) {
                    ...
                    log.trace("updateData(): [" + command + "] -> nav2 stand-by set to " + formatted8);
                }
                break;
            ...
            case "adf1_freq":
                ...
                if (!adf1Text.getText().equals(raw9)) {
                    ...
                    log.trace("updateData(): [" + command + "] -> adf1 set to " + raw9);
                }
                break;
            ...
            case "adf1_stdby_freq":
                ...
                if (!adf1Stby.getText().equals(raw10)) {
                    ...
                    log.trace("updateData(): [" + command + "] -> adf1 stand-by set to " + raw10);
                }
                break;
